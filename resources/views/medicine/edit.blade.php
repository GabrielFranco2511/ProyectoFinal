...
@else
	<div class="container text-center">
		<div class="page header">
			<br><br>
			<h2 style="color: white; text-align: center;"> Editando producto</h2>
		...
		<div class="row">
			<div class="col-md-offset-3 col-md-6">
				...
				@endif--}}
<br>
				{!! Form::model($medicine,array('route'=>array('medicine.update', $medicine)))!!}
				...
				<div class="form-group">
					...
					<div class="form-group">
						...
						{!! Form::submit(
							'Actualizar',array('class'=>'btn btn-primary'))!!}
						<a href="{{route('medicine.index')}}" class="btn btn-danger"> Regresar </a>
